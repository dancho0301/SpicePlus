...
# 最初に、あなたのアプリケーションに必要なモジュールを設定します
# デフォルトではコアモジュール以外何もインストールしません（password, encryption, login/logoutのみ）
# 利用可能なサブモジュールは :user_activation, :http_basic_auth, :remember_me,
# :reset_password, :session_timeout, :brute_force_protection, :activity_logging, :external
